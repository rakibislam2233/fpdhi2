...
import { reduceNanArrSum, rejectSpecificWord } from "../../utils/Utils.jsx";
const remove_nan = (d) => (d ? d : "");
const remove_single_nan = (num1, num2) => {
  var n1 = num1 ? parseInt(num1) : 0;
  var n2 = num2 ? parseInt(num2) : 0;
  return n1 + n2;
};
const orgUnit = {
  title: "নাম",
                ...
                children: [
                  {
                    title: "৭০",
                    className: "cl-no",
                    key: "kON6kM1s8Z4-iewWuv1Q35x_kON6kM1s8Z4-Rer4EzwcQBf_kON6kM1s8Z4-q725bxlWUuc_kON6kM1s8Z4-F1aJHMS9nN3",
                    render: (value, row, index) => {
                      var sum =
                        parseInt(row["kON6kM1s8Z4-iewWuv1Q35x"]) +
                        parseInt(row["kON6kM1s8Z4-Rer4EzwcQBf"]) +
                        parseInt(row["kON6kM1s8Z4-q725bxlWUuc"]) +
                        parseInt(row["kON6kM1s8Z4-F1aJHMS9nN3"]);
                      return (
                        remove_single_nan(
                          row["kON6kM1s8Z4-iewWuv1Q35x"],
                          row["kON6kM1s8Z4-Rer4EzwcQBf"]
                        ) +
                        remove_single_nan(
                          row["kON6kM1s8Z4-q725bxlWUuc"],
                          row["kON6kM1s8Z4-F1aJHMS9nN3"]
                        )
                      );
                    },
                  },
        ...
        children: [
          {
            ...
            children: [
              {
                title: "স্থায়ী পদ্ধতির সর্বমোট প্রসব পরবর্তী  মেয়াদ উর্ত্তীণ",
                className: "r-th",
                children: [
                  {
                    title: "৭৮",
                ...
                children: [
                  {
                    ...
                    render: (v, row, index) => {
                      // console.log(parseInt(row["kON6kM1s8Z4-tf6Ohcc1Hgy"]), parseInt(row["g1auXPxaILY-HllvX50cXC0"])
                      //     , parseInt(row["hJKvjSRrdvo-HllvX50cXC0"]), parseInt(row["i27Oz4EeNWC-HllvX50cXC0"]), parseInt(row["ADLwP5Bj6Y0-HllvX50cXC0"])
                      //     , parseInt(row["Ev66FqIgcam-HllvX50cXC0"]), parseInt(row["l4LrQzABAFJ-HllvX50cXC0"]));
                      console.log(row);
                      var n = reduceNanArrSum([
                        parseInt(row["dYXyd0ZenSJ-HllvX50cXC0"]),
                        parseInt(row["g1auXPxaILY-HllvX50cXC0"]),
                        parseInt(row["hJKvjSRrdvo-HllvX50cXC0"]),
                        parseInt(row["i27Oz4EeNWC-HllvX50cXC0"]),
                        parseInt(row["ADLwP5Bj6Y0-HllvX50cXC0"]),
                        parseInt(row["Ev66FqIgcam-HllvX50cXC0"]),
                        parseInt(row["l4LrQzABAFJ-HllvX50cXC0"]),
                      ]);

                      var d = parseInt(row["wSxlRUK6SEt-HllvX50cXC0"]);
        ...
        children: [
          {
            ...
            children: [
              {
                title:
                  "গর্ভপাত, এমআর এবং এমআরএম পরবর্তী পরিবার পরিকল্পনা \nপদ্ধতি গ্রহণকারীর সংখ্যা",
                className: "r-th",
                children: [
                  {
                    title: "৮৪",
...
export const mis4columns_child_birth_death = [
  {
    className: "rm-b-t1",
    children: [
      {
